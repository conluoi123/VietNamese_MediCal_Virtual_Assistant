...
\input{sections/s1_overview}
\input{sections/s1_formula_summary}
\input{sections/s2_theory}
\input{sections/s3_aggregated}
\input{sections/s4_advances}
\input{sections/s5_demo_evaluation}
