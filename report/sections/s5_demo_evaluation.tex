...
\begin{itemize}
    \item \textbf{Địa chỉ trọng số mô hình (HuggingFace Hub):} \href{https://huggingface.co/ntthanh0307/vit5-vimedaq-medical-qa}{ntthanh0307/vit5-vimedaq-medical-qa}.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/GiaoDien.png}
...
\begin{itemize}
    \item \textbf{Liên kết ứng dụng Web Demo (HuggingFace Spaces):} \href{https://huggingface.co/spaces/ntthanh0307/vimedaqa-medical-chatbot}{ntthanh0307/app}
    %\href{https://huggingface.co/spaces/quoc123kaka/test_rag}{quoc123kaka/test\_rag}.
\end{itemize}